...
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "Tm.Beta"; ModuleVersion = "1.4.6"}
```
...
## Documentation for Models
 ...
 - [Tm.Beta\Model.ArrayInner1](docs/ArrayInner1.md)
 ...
 - [Tm.Beta\Model.JsonPatchOperations](docs/JsonPatchOperations.md)
 - [Tm.Beta\Model.JsonPatchOperationsValue](docs/JsonPatchOperationsValue.md)
